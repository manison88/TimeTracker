      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
        <div className="text-center">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-2xl mx-auto">
            Simple, focused time tracking for freelancers and side-project builders.
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8">
          <FeatureCard
            ...
            description="Organize your work into projects and features. Track time at any level."
          />
          <FeatureCard
            icon={<TimerIcon className="w-8 h-8" />}
            title="One-Click Timer"
            description="Start and stop timers with a single click. Auto-stop when switching tasks."
          />
          <FeatureCard
            icon={<InsightsIcon className="w-8 h-8" />}
            title="Insights"
            description="See where your time goes with per-project breakdowns and totals."
          />
        </div>
      </main>
    </div>
